...
<body>
	...
	<header>
		...
		<ul class="login">
			<button type="button" class="btn btn-outline-gray" onclick="location.href='loginForm.jsp'">로그인</button>&nbsp;
			<button type="button" class="btn btn-outline-gray" onclick="location.href='register.jsp'">회원가입</button>
		</ul>
	</header>
	<!-- header end-->
